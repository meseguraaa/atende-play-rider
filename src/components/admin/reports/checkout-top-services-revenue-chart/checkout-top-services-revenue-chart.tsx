...
type CheckoutTopServicesRevenueChartItem = {
    name: string;
    value: number;
};

type CheckoutTopServicesRevenueChartProps = {
    data: CheckoutTopServicesRevenueChartItem[];
};

type ServicesTooltipPayload = {
    value: number | string | undefined;
    payload: CheckoutTopServicesRevenueChartItem;
};
...
export function CheckoutTopServicesRevenueChart({
    data,
}: CheckoutTopServicesRevenueChartProps) {
        ...
        <Card className="border-border-primary bg-background-secondary">
            <CardHeader>
                ...
                <CardDescription className="text-paragraph-small text-content-secondary">
                    Top serviços por receita gerada no checkout no mês
                    selecionado.
                </CardDescription>
            </CardHeader>
